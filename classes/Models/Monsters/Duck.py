...
from file_for_images import duck_list, convert_list_of_images


class Duck(Monster):
    def __init__(self):
        Monster.__init__(self, 10000, 10000, 0, 0, 10000, Weapon("Cry of Crya", 1000),
                         duck_list)  # возможно надо сделать новый класс для оружия утки
